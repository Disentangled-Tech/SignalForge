...
- **Module name:** Implement the new service under `app/extractor/` (not under `app/services/extractor.py`) to avoid confusion with the existing HTML extractor. The HTML extractor remains at `app/services/extractor.py` unchanged.
