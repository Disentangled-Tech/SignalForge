...
4) Outreach Types and What They Mean
...
5) Neurodivergent-Aware Message Rules
...
6) Message Template Library (Parameterized)
...
7) Ranking and Personalization (Minimal but Powerful)
...
9) Success Metrics (for the Outreach Engine)
