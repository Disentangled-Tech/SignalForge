...
Unified orchestrator for cron: ingest, derive, score. On success, queries
ranked companies via get_emerging_companies. One adapter failure does not
kill ingest. Stage failure: derive/score run on existing data; partial
...
def run_daily_aggregation(
    ...
    try:
        ...
        # Ranked list for monitoring: threshold=0 to include all scored companies
        from app.services.briefing import get_emerging_companies
