...
One row per (workspace_id, pack_id, entity_id). Populated from ReadinessSnapshot +
EngagementSnapshot after score. Briefing reads from lead_feed when populated.
"""
