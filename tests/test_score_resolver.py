...
def test_get_company_score_from_snapshot(db: Session, fractional_cto_pack_id) -> None:
...
def test_get_company_scores_batch_multiple_companies(db: Session, fractional_cto_pack_id) -> None:
